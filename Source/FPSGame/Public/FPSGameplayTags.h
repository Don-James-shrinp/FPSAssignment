...
namespace FPSGameplayTags
{
	...
	/** Enemy Tags **/
	FPSGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Ability_Fire);

	FPSGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Weapon_Rifle);
	...
	FPSGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_Bullet_Hit);
